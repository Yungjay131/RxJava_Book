...
public class FeedParserXML {
     ...
     */
    public List<NewsEntry> parse(InputStream in)
     ...
     * @throws IOException on I/O error.
     */
    private List<NewsEntry> readFeed(XmlPullParser parser)
            throws XmlPullParserException, IOException, ParseException {
     ...
     */
    private NewsEntry readEntry(XmlPullParser parser)
            throws XmlPullParserException, IOException, ParseException {
        ...
        return new NewsEntry(id, title, link, updatedOn);
    }
